...
# Create Users
User.create!(username: 'admin', email: 'admin@example.com', password: 'password', role: 1) # Admin
User.create!(username: 'user1', email: 'user1@example.com', password: 'password', role: 0) # Regular user
User.create!(username: 'user2', email: 'user2@example.com', password: 'password', role: 0)
...
q1 = Question.create!(content: 'What is the output of 1 + 1 in Ruby?', exam: exam1)
q2 = Question.create!(content: 'What keyword is used to define a method in Ruby?', exam: exam1)
...
q3 = Question.create!(content: 'What is Rails?', exam: exam2)
q4 = Question.create!(content: 'Which command generates a controller in Rails?', exam: exam2)
